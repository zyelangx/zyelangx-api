...
const menus = {
    ...
    downloader:[
        {
            name: "Youtube Mp4",
            url: "/api/downloader/ytmp4?url=https://youtu.be/Nq5rzeJ5Ab4"
        },
        {
            name: "Youtube Mp3",
            url: "/api/downloader/ytmp3?url=https://youtu.be/Nq5rzeJ5Ab4"
        }
    ]
}
...
function menuss() {
    ...
    for (var e of menus.downloader){
        // Downloader
        downloader.innerHTML += `<li class="">
        <a class="sidenav-item-link" href="${e.url.trim()}">
          <span class="nav-text">${e.name.trim()}</span>
        </a>
      </li>`
